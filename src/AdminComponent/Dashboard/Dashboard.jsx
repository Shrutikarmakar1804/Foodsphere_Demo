...
export const RestaurantDashboard = () => {
  ...
  const recentOrders = [
    ...
    // { id: "#ORD1029", customer: "Suresh Yadav", total: "₹800", status: "Preparing" },
    // { id: "#ORD1030", customer: "Tina Desai", total: "₹900", status: "Delivered" }
  ];
    ...
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      <div className="flex-1 p-6 space-y-6">
        ...
        <header className="flex justify-between items-center">
          ...
          <input type="text" placeholder="Search..." className="border px-3 py-1 rounded-lg w-64" />
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="col-span-2 bg-white rounded-xl shadow p-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="bg-blue-600 text-white px-4 py-2 rounded-lg">+ Create Order</button>
            </div>
            ...
            <ul className="space-y-3">
              {trendingItems.map((item, i) => (
                <li key={i} className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-blue-600">{item.orders}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl shadow">
          ...
          <div className="flex space-x-4 overflow-x-auto pb-2">
            {foodItems.map((item, i) => (
              <div key={i} className="min-w-[150px] bg-gray-100 p-3 rounded-xl text-center shadow-sm">
